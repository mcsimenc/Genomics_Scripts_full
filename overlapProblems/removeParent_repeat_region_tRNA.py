...
for line in sys.stdin:
	if not line.startswith('#'):
		...
		if gffLine.type == 'LTR_retrotransposon' or gffLine.type=='tRNA':
			del gffLine.attributes['Parent']
			gffLine.attributes_order.pop(gffLine.attributes_order.index('Parent'))
